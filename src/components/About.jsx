...
import codeweb from '../assets1/codeweb.png'
import codeclan from '../assets1/Code Clan.png'
import devx from '../assets1/DevX Clan.png'
import python from '../assets1/Python Hunters.png'
import opensource from '../assets1/Open Source Club.png'
...
const objects=[
  {
    ...
    function About() {
      ...
      return (
        <div className="About">
          <h1>About Us</h1>
          <div className={showAll?"object-container":"object-container1"}>
            {showAll
              ...
              : objects[0].aboutus.slice(0, 4).map((club, index) => (
                  <div key={index} className="object1" >
